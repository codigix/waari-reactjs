			...
			render: (item) => (
				<>
					<div className="d-flex justify-content-center">
						<span
							onClick={() => navigate(`/view-tour-details/${item.groupTourId}`)}
						>
						...
						{hasComponentPermission(permissions, 77) && (
							<span
								className=""
								onClick={() => {
									navigate(`/edit-group-tour/${item?.groupTourId}`);
								}}
							>
								<Link
									// to="/group-edit-tour"
						...
						<span
							className=""
							onClick={() => navigate(`/copy-group-tour/${item?.groupTourId}`)}
						>
						...
						<button
							onClick={() => exportToExcel(item.groupTourId, item.tourName)}
			...
			render: (item) => (
				<>
					<div className="d-flex justify-content-center gap-2">
						...
						{item.predepartureUrl ? (
							<a target="_blank" href={item.predepartureUrl}>
								<button className="btn-tick me-2">
									<Tooltip title="Predeparture PDF">
										<svg
											xmlns="http://www.w3.org/2000/svg"
											width="16"
											height="16"
	...
	const getViewgrouplist = async () => {
		try {
			...
			const response = await get(
				`/view-group-tour?perPage=${perPageItem}&page=${page}&tourName=${tourName}&tourType=${tourType?.value || ""
				...
				<div className="col-lg-12" style={{ paddingTop: '40px' }}> 
					<div className="card ">
						<div className="row page-titles mx-0 fixed-top-breadcrumb">
							<ol className="breadcrumb ">
								...
								<li className="breadcrumb-item  ">
									<Link to="/View-group-tour">Group Tour</Link>
								</li>
							</ol>
						</div>
					</div>
					<div className="card">
						<div className="card-body">
							{hasComponentPermission(permissions, 73) && (
								<div className="d-flex mb-3 justify-content-end">
									<Link
										to="/add-new-group-tour"

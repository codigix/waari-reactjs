...
function CopyGroupTour() {
		...
		flights: Yup.array().when("departure", {
			...
			otherwise: Yup.array().of(
				Yup.object().shape({
					...
					weight: Yup.string().required("To Time is required"),
				})
			),
		}),
		trains: Yup.array().of(
	...
	const formik = useFormik({
		...
		onSubmit: async (values) => {
			...
			try {
				setIsLoading(true);
				const response = await post(`add-group-tour`, data);
				setIsLoading(false);
	...
	const getMinEndDate = () => {
		...
		startDate.setDate(
			startDate.getDate() + formik.values.itinerarydate?.length
		);
	...
	const getFileLink = async (file, fieldName) => {
		try {
			...
			if (!isValidImageSize(imageSize, fieldName)) {
				toast.error(
					"Invalid image size. Please upload an image with dimensions 1080x1920."
				);
				return;
			}
			...
			<div className="card"  style={{ marginBottom: '40px' }}>
				<div className="row page-titles mx-0 fixed-top-breadcrumb">
					   <ol className="breadcrumb">
						...
						<li className="breadcrumb-item  ">
							<Link to="javascript:void(0)">Add Tour</Link>
						</li>
					</ol>
				</div>
			</div>
							...
							<div className="card-body">
								...
								<div className="row">
									...
									<div className="col-md-4 col-sm-6 col-lg-3 col-12">
										<div className="mb-2">
											...
											<input
												...
												name="tourenddate"
												min={
													formik.values.itinerarydate?.length
														? getMinEndDate()
														: undefined
												}
												className="form-control"
										...
										<div className="mb-2">
											<div className="row">
												...
												<div className="col-sm-6 pax-child">
													<label>
														Duration(Days)<span className="error-star">*</span>
													</label>
													<input
														type="text"
														className="form-control w-60"
									...
									<div className="col-md-3 col-sm-6 col-lg-2 col-12">
										<div className="mb-2">
											<label>
												Tour Manager Name<span className="error-star">*</span>
											</label>
											<input
												type="text"
												className="form-control"
									...
									<div className="col-md-3 col-sm-6 col-lg-2 col-12">
										<div className="mb-2">
											<label>
												Tour Manager Number<span className="error-star">*</span>
											</label>
											<input
												type="text"
												className="form-control"
										...
										<div className="tourprice mb-2">
											...
											<div className="table-responsive">
												<table className="table table-bordered table-responsive-sm table-tour table-gt">
													<thead>
														<tr>
															<th style={{ width: "200px", cursor: "default" }}>
																Room Sharing
															</th>
															<th style={{ width: "100px", cursor: "default" }}>
																Tour Price
															</th>
															<th style={{ width: "100px", cursor: "default" }}>
																Offer Price
														...
														(item, index) => (
															<div className="row">
																				...
																				<div className="Neon Neon-theme-dragdropbox">
																					...
																					<div className="Neon-input-dragDrop">
																						{formik.values.bannerImage?.length ==
																							...
																							<img
																								src={formik.values.detailIntenirary[index].bannerImage || NoImage}
																								alt="frontImage"
																								width="100%"
																								className="neon-img"
																							/>
																				...
																				<div className="Neon Neon-theme-dragdropbox">
																					...
																					<div className="Neon-input-dragDrop">
																						{formik.values.hotelImage?.length ==
																							...
																							<img
																								src={formik.values.detailIntenirary[index].hotelImage || NoImage}
																								alt="frontImage"
																								width="100%"
																								className="neon-img"
																							/>
																...
																<div className="col-md-5 mt-2">
																	...
																	<div className="form-check form-check-inline d-flex" style={{ paddingLeft: "0" }}>
																		<label
										...
										<div className="col-md-12">
											<div className="skeleton mb-2">
												...
												<div className="row">
													...
													<div className="col-md-6 mb-2">
														<label>
															Visa Fees<span className="error-star">*</span>
														</label>
														<input
															type="text"
															className="form-control"
													...
													<div className="col-md-6 mb-2">
														<label>
															Visa Alerts<span className="error-star">*</span>
														</label>
														<input
															type="text"
															className="form-control"
								...
								<div className="row">
									<div className="col-md-12">
											...
											>
												<div className="card-title h5">
													...
													<Tooltip title="Add">
														...
														>
															<svg xmlns="http://www.w3.org/2000/svg" height="1em" fill="#07" viewBox="0 0 448 512"><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"></path></svg>
														</button>
													</Tooltip>
												</div>
											</div>
										...
										<div className="notes mb-3">
											...
											>
												<div className="card-title h5">
													Website Description (Overview) <span className="error-star">*</span>
												</div>
											</div>
											<textarea
												type="text"
									...
									<div className="col-lg-12 d-flex justify-content-between mt-3">
										<Link to="/View-group-tour" type="submit" className="btn btn-back">
											Back
										</Link>
										<div className="d-flex">
											<button

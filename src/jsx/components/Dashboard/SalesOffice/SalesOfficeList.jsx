...
const SalesOfficeList = () => {
    ...
    const handleDelete = async () => {
        try {
            ...
            const responseData = await get(
                `/delete-office-details?officedetailId=${deleteId}`
            );
            setOpen(false);
            setRender(!render);
    ...
    //GET GUEST LIST
    const getSalesOfficeList = async () => {
        try {
            setIsTableLoading(true);
            const response = await get(`list-office-details?&page=${page}&perPage=${perPageItem}`);
            setSalesOfficeList(response?.data?.data);
            ...
            render: (item) => (
                <>
                    <div className="d-flex justify-content-center ">
                        {hasComponentPermission(permissions, 338) && (
                            <Link
                                to={`/edit-sales-office/${item.officedetailId}`}
                        ...
                        {hasComponentPermission(permissions, 336) && (
                            <button
                                className="btn-trash"
                                onClick={() =>
                                    handleOpenDelete(item?.officedetailId)
                                }
                            >
    ...
    useEffect(() => {
        hasComponentPermission(permissions, 335) && getSalesOfficeList();
                ...
                <div className="col-lg-12" style={{ paddingTop: '40px' }}>
                    ...
                    <div className="card">
                        <div className="card-body">
                            { hasComponentPermission(permissions, 334) &&
                    ...
                    {hasComponentPermission(permissions, 335) ? (
                        <div className="card">
                            <div className="card-body">
                                <div
...
export default SalesOfficeList;

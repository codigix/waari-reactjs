...
const EditSalesOffice = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                const result = await post(`update-office-details`, {...values, officedetailId: id});
    ...
    const getSalesOfficeData = async () => {
        try {
            const result = await get(`edit-office-details?officedetailId=${id}`);
                    ...
                    <div className="card">
                        ...
                        <li className="breadcrumb-item">
                            <BackButton />
                                ...
                                <li className="breadcrumb-item  ">
                                    <Link to="javascript:void(0)">Edit Sales Office</Link>
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="card-header mb-2 p-0">
                                <div className="card-title h5">Edit Sales Office</div>
                            </div>

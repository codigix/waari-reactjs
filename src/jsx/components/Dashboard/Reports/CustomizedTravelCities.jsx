...
function Customizedtravelcities() {
    ...
    return (
        <>
            <div className="card"  style={{ marginBottom: '40px' }}>
                <div className="row page-titles mx-0 fixed-top-breadcrumb">
                       <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item">
                            <Link to="/customized-travel-cities">Customized Travel Cities</Link>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div className="card">
                <div className="card-body">
                    <div className="row">
                        ...
                        <div className="card-header  card-header-title p-0 mb-2"><div className="card-title h5">No. of guests travelled in Customised Tour (Domestic)</div></div>
                            ...
                            <table className="table table-bordered table-responsive-sm table-tour">
                                ...
                                <tbody className="divide-y divide-gray-600">
                                    ...
                                    <tr style={{background:"#f8f8f8"}}>
                                        ...
                                        <td colSpan="13" className="px-6 py-4 whitespace-nowrap text-center"><b>Grand Total</b></td>
                                        <td className="px-6 py-4 whitespace-nowrap text-center"><b>277800s</b></td>
            ...
            <div className="card">
                ...
                <div className="row">
                        <div className="col-md-12 ">
                    <div className="card-header  card-header-title p-0 mb-2"><div className="card-title h5">No. of guests travelled in Customised Tour (International)</div></div>
                    <div className="table-responsive">
                        <table className="table table-bordered table-responsive-sm table-tour">
                            <thead>
                                <tr>
                            ...
                            <tbody className="divide-y divide-gray-600">
                                ...
                                <tr style={{background:"#f8f8f8"}}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-center" style={{color:"#000"}}><b>77800</b></td>
...
export default Customizedtravelcities;

...
function Customizedtourleadrecord() {
    ...
    return (
        <>
            <div className="card-header  card-header-title pt-0 pb-0 mb-2"><div className="card-title h5">Customised Tour Leads Record</div></div>
...
export default Customizedtourleadrecord;

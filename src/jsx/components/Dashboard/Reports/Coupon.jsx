            ...
            <div className="card">
                <div className="row page-titles mx-0">
                       <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item">
                            <Link to="/coupon-report">Coupon</Link>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div className="card">
                <div className="card-body">
                    ...
                    <div className="row">
                        ...
                        <div className="card-header  card-header-title p-0 mb-2"><div className="card-title h5">  Coupons Report FY 2023-24</div></div>
                            ...
                            <table className="table table-bordered table-responsive-sm table-tour">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="" style={{ cursor: 'pointer' }}>Coupon Code<span></span></th>
                                        <th className="" style={{ cursor: 'pointer' }}>Valid from<span></span></th>
                                        <th className="" style={{ cursor: 'pointer' }}>Valit till<span></span></th>
                                        <th className="" style={{ cursor: 'pointer' }}>Used by guests<span></span></th>
                                        <th className="" style={{ cursor: 'pointer' }}>Sales (Rs)<span></span></th>
                                        <th className="" style={{ cursor: 'default' }}>Total Dicount</th>
                                ...
                                <tbody className="divide-y divide-gray-600">
                                    ...
                                    <tr style={{backgroundColor:"#f8f8f8"}}>
                                        ...
                                        <td colSpan="5" className="px-6 py-4 whitespace-nowrap text-center" style={{color:"#000"}}><b>Grand Total</b></td>

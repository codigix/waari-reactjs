        ...
        <>
            <div className="card"  style={{ marginBottom: '40px' }}>
                <div className="row page-titles mx-0 fixed-top-breadcrumb">
                       <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item">
                            <Link to="/grouptour-profit">Group Tour Profit</Link>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div className="card-body">
                    ...
                    <div className="row">
                        <div className="col-md-12 ">
                            ...
                            <div className="card-header  card-header-title p-0 mb-2"><div className="card-title h5">Destination-Wise Yearly Sale in Group Tour (Domestic)</div></div>
            ...
            <div className="card">
                <div className="card-body">
                    <div className="row">
                        <div className="col-md-12 ">
                            <div className="card-header  card-header-title p-0 mb-2"><div className="card-title h5">Destination-Wise Yearly Sale in Group Tour (International)</div></div>
                            <div className="table-responsive">
                                <table className="table table-bordered table-responsive-sm table-tour">
                                    <thead>
                                        <tr>
...
export default Grouptourprofit;

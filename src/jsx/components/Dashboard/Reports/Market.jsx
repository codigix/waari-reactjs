...
import Grouptourleadrecord from "./Grouptourleadrecord";
import Customizedtourleadrecord from "./Customizedtourleadrecord";
import Alltourleadrecord from "./Alltourleadrecord";
                ...
                <>
                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                <div className="col-md-12 ">
                                   ...
                                   <Grouptourleadrecord></Grouptourleadrecord>
                            </div>
                        </div>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-body">
                            <div className="row">
                                <div className="col-md-12">
                                 <Customizedtourleadrecord></Customizedtourleadrecord>
                            </div>
                          </div>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-body">
                            <div className="row">
                                <div className="col-md-12">
                                 <Alltourleadrecord></Alltourleadrecord>
                            </div>
                            </div>
                        </div>
                    </div>

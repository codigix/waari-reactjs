            ...
            <div className="card"  style={{ marginBottom: '40px' }}>
                <div className="row page-titles mx-0 fixed-top-breadcrumb">
                       <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item">
                            <Link to="/customized-guest-travel">Customized Guest Travel</Link>
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <table className="table table-bordered table-responsive-sm table-tour">
                                ...
                                <tbody className="divide-y divide-gray-600">
                                    ...
                                    <tr style={{backgroundColor:"#f8f8f8"}}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-center"><b>277800</b></td>
...
export default Customizedguesttour;

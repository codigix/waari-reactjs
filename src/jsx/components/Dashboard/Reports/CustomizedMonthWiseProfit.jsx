...
function CustomizedMonthWiseProfit() {
    ...
    return (
        <>
            {hasComponentPermission(permissions, 80) &&
                <>
                    <div className="card"  style={{ marginBottom: '40px' }}>
                        ...
                        <li className="breadcrumb-item">
                            <BackButton />
                                ...
                                <li className="breadcrumb-item">
                                    <Link to="/customized-monthwise-profit">Customized Monthwise Profit</Link>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                <div className="col-md-12 ">
                                    ...
                                    <div className="card-header  card-header-title p-0 mb-2"><div className="card-title h5">Destination-Wise Yearly Sale in Customised Tour (Domestic)</div></div>
                                        ...
                                        <table className="table table-bordered table-responsive-sm table-tour">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className="" style={{ cursor: 'pointer' }}>Guests<span></span></th>
                                                    <th className="" style={{ cursor: 'pointer' }}>Average Sale/person<span></span></th>
                                                    <th className="" style={{ cursor: 'pointer' }}>Average Profit/person<span></span></th>
                                                    <th className="" style={{ cursor: 'pointer' }}>Total Profit%<span></span></th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-gray-600">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-center" style={{color:"#000"}}></td>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-center" style={{color:"#000"}}><b>678</b></td>
                                                    <td className="px-6 py-4 whitespace-nowrap text-center" style={{color:"#000"}}><b>789</b></td>
                                                    <td className="px-6 py-4 whitespace-nowrap text-center" style={{color:"#000"}}><b>789</b></td>
                                                    <td className="px-6 py-4 whitespace-nowrap text-center" style={{color:"#000"}}><b>900</b></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="row">
                            <div className="col-md-12 ">
                                <div className="card-header  card-header-title p-0 mb-2"><div className="card-title h5">Destination-Wise Yearly Sale in Customised Tour (International)</div></div>
                                <div className="table-responsive">
                                    <table className="table table-bordered table-responsive-sm table-tour">
                                        <thead>
                                            <tr>
...
export default CustomizedMonthWiseProfit;

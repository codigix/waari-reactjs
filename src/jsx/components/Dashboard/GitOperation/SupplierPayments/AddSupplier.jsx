...
const AddSupplier = ({ tourId, handleSucessAdd }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                const result = await post(`add-gt-supplier-payments-details`, {
                    ...values,
                    groupTourId: tourId,
                });
    ...
    useEffect(() => {
        let element = document.getElementById("supplier-payments-list");
        if (element) {
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="card-header mb-2 p-0">
                                <div className="card-title h5">Add Supplier</div>
                            </div>
                                        ...
                                        >
                                            <div className="row pe-3">
                                                ...
                                                {formik.touched.paymentDetails &&
                                                    formik.touched.paymentDetails[index] &&
                                                    formik.errors.paymentDetails &&
                                                    formik.errors.paymentDetails[index] && (

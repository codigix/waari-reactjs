...
const Guesttour = () => {
	...
	const columns = [
		...
		hasComponentPermission(permissions, 30)
			? {
					title: "Status",
					render: (item) => (
						<>
							<div className="d-flex justify-content-center">
								{/* <Link
              to="/booking"
              className="btn-success btn btn-sm  btn-tick mx-2 "
            >
              <svg
              ...
              >
                <path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" />
								...
								{/* <Link
              to="/lost-grouptour"
              className="btn-danger btn-tick btn btn-sm"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="1em"
	...
	const columns_upcoming = [
		...
		hasComponentPermission(permissions, 30)
			? {
              ...
              className=" btn-tick"
            >
              <svg xmlns="http://www.w3.org/2000/svg" classname="svg-edit" height="1em" viewBox="0 0 512 512">
	...
	useEffect(() => {
		hasComponentPermission(permissions, 27) && UpcomingFollowUp();
	...
	return (
		<>
			...
			{hasComponentPermission(permissions, 27) && (
				<div className="row">

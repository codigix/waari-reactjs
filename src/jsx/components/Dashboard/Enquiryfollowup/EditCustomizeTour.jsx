...
const EditCustomizeTour = () => {
    ...
    const validation = useFormik({
        ...
        onSubmit: async (values) => {
            let data = {
                ...
                contactName: values.nameofcontact,
    ...
    const getDestValueFromSelect = async (value) => {
        ...
        setDataToPatch((r) => ({ ...r, destinationId: value.value, cities: "[]", state: "" }))
    };
    const getCountryValueFromSelect = async (value) => {
        ...
        validation.setFieldValue('cities', [])
        validation.setFieldValue('state', '')
        setDataToPatch((r) => ({ ...r, countryId: value.value, cities: "[]", state: "" }))
    };
                    ...
                    <div className="card">
                        ...
                        <li className="breadcrumb-item">
                            <BackButton />
                                ...
                                <li className="breadcrumb-item  ">
                                    <Link>Edit Customized Tour</Link>
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="mb-2 col-md-3">
                                            ...
                                            <input
                                                ...
                                                onChange={validation.handleChange}
                                                onBlur={validation.handleBlur}
                                                value={validation.values.nameofcontact}
                                            />
                                            {validation.touched.nameofcontact &&
                                                validation.errors.nameofcontact ? (
                                                <span className="error">
                                                    {validation.errors.nameofcontact}
                                                </span>
                                            ) : null}
                                        ...
                                        <div className="mb-2 col-md-4">
                                            ...
                                            <Select
                                                ...
                                                onChange={(selectedOption) => {
                                                    ...
                                                    setDataToPatch((r) => ({ ...r, state: selectedOption.value, cities: "[]" }))
                                                }}
                                                onBlur={validation.handleBlur}
                                                value={
                                                    state.find(
...
export default EditCustomizeTour;

...
const DetailInteniraryForm = ({ groupTourId, tourdurationdays, toursData, dayDifference }) => {
                                                            ...
                                                            (subItem, subIndex) => (
                                                                <div key={subIndex} className="row">
                                                                    ...
                                                                    <div className="col-md-6">
                                                                        ...
                                                                        <span className="error">
                                                                        {
    formik.errors?.detailIntenirary?.[index]?.grouptouritineraryimages?.[subIndex]?.itineraryImageUrl && 
    formik.touched?.detailIntenirary?.[index]?.grouptouritineraryimages?.[subIndex]?.itineraryImageUrl && (

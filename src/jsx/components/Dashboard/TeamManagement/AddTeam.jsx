    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                const result = await post("add-team-lead", data);
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div
                                ...
                                style={{ paddingLeft: "0" }}
                            >
                                <div className="card-title h5">Add Team</div>
                            </div>
                            ...
                            >
                                <div className="row">
                                    ...
                                    <div className="col-md-5 col-lg-3 col-sm-6 col-12">
                                        ...
                                        <Select
                                            ...
                                            onChange={(selectedOption) => {
												...
												setUsers(teamLeaders.filter(user => user.value !== selectedOption.value));
												formik.setFieldValue("assignAgents", formik.values.assignAgents.filter(prev => prev.value !== selectedOption.value));
                                            }}
                                            onBlur={formik.handleBlur}
                                    ...
                                    <div className="col-lg-6 col-md-8 col-sm-12 col-12">
                                        <div className="mb-2">
                                            ...
                                            <Select
                                                ...
                                                classNamePrefix="select"
                                                options={users}
                                                onChange={handleAssignAgentsChange}
                                                value={formik.values.assignAgents}
                                            />
                                            <ErrorMessageComponent
                                                errors={formik.errors}

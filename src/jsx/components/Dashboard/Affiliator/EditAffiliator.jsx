...
const validationSchema = Yup.object().shape({
	...
	fbLink: Yup.string().url("Invalid URL format").nullable(),
	instagramLink: Yup.string().url("Invalid URL format").nullable(),
	twitterLink: Yup.string().url("Invalid URL format").nullable(),
	otherLink: Yup.string().url("Invalid URL format").nullable(),
});
	...
	const formik = useFormik({
		...
		onSubmit: async (values) => {
			try {
				...
				const result = await post("/update-info-influencer-affiliate", data);
					...
					<div className="card">
                        ...
                        <li className="breadcrumb-item">
                            <BackButton />
								...
								<li className="breadcrumb-item  ">
									<Link to={"/edit-affiliator/" + id}>Edit Affiliator</Link>
								</li>
							</ol>
						</div>
					</div>
							...
							<div className="basic-form">
								...
								>
									<div
										...
										style={{ paddingLeft: "0" }}
									>
										<div className="card-title h5">Edit Affiliator</div>
									</div>
									<div className="row">

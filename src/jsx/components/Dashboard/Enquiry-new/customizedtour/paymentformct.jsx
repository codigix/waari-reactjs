...
const PaymentFormCT = ({
    ...
    const getCustomTourBillDetails = async () => {
        try {
            const response = await get(
                `/view-bill-ct?enquiryDetailCustomId=${familyHead.enquiryDetailCustomId}`
            );
    ...
    return (
        <>
            ...
            >
                    ...
                    <div className="">
                        ...
                        <div className="basic-form">
                            ...
                            <div className="mb-2 row">
                                ...
                                <div className="col-md-5">
                                    <div className="view-details">
                                        <h6 style={{ color: "#299e4a" }}>
                                            {groupTourBillDetails?.grandTotal}
                                        </h6>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        {item.status == 0 ? (
                                                            ...
                                                            <>
                                                                <div className="d-flex  mt-2 mt-lg-0 mt-md-0">
                                                                    ...
                                                                    {
                                                                        <Link
                                                                            to={`/receipt-ct/${item.customPayDetailId}/${familyHead.enquiryDetailCustomId}`}
                        ...
                        <div className="mb-2 row">
                            ...
                            <div className="col-md-4">
                                {groupTourBillDetails?.isPaymentDone && (
                                    <div className="col-md-4">
                                        <Link
                                            to={`/invoice-ct/${familyHead.enquiryDetailCustomId}`}
                                            className="btn btn-secondary add-btn btn-sm"
                                            style={{
                                                height: "32px",
                                                margin: "0px 10px 0px 0px",
                ...
                balance &&
                balance > 0 &&
                hasComponentPermission(permissions, 155) ? (
                    <div className="">
                        <div className="card-header p-0 mb-2 card-header-second">
                                    ...
                                    <div className="col-md-5">
                                        <Select
                                            ...
                                            value={cardTypeDropDown.find(
                                                (option) =>
                                                    option.value === validation.values.cardType
                                            )}
                                        />
                                        {validation.touched.cardType &&
                                        validation.errors.cardType ? (
                                            <span className="error">
                                                {validation.errors.cardType}
                                            </span>
                                        ) : null}
                                    ...
                                    <div className="Neon Neon-theme-dragdropbox cheque-upload">
                                        ...
                                        <div className="Neon-input-dragDrop">
                                            {validation.values.transactionproof?.length == 0 ? (
                                                ...
                                                <img
                                                    src={
                                                        validation.values.transactionproof ||
                                                        NoImage
                                                    }
                                                    alt="frontImage"
                                                    width="100%"

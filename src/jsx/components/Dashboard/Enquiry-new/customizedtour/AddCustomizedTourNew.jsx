...
const AddcustomizedtourNew = () => {
	...
	const validation = useFormik({
		...
		validationSchema: Yup.object({
			...
			sectorId: Yup.string().required("Enter The Sector"),
	...
	useEffect(() => {
		...
		let element = document.getElementById("customized-tour-new");
		if (element) {
					...
					<div className="card">
                        ...
                        <li className="breadcrumb-item">
                            <BackButton />
								...
								<li className="breadcrumb-item">
									<Link to="/customized-tour-new">Enquiry follow-up</Link>
								</li>
								<li className="breadcrumb-item  ">
									<Link to="/add-customized-tour-new">Add Customized Tour</Link>
								</li>
							</ol>
						</div>
					</div>
                                    ...
                                    <div className="row">
										...
										<div className="mb-2">
											...
											<Select
												...
												value={
													sectorOptions.find(
														(option) => option.value === validation.values.sectorId
													)
														? sectorOptions.find(
																(option) =>
																	option.value === validation.values.sectorId
														  )
														: null
												}
											/>
											{validation.touched.sectorId &&
												validation.errors.sectorId && (
													<span className="error">
														{validation.errors.sectorId}
													</span>
												)}
										...
										{validation.values.childrenages &&
											validation.values.childrenages.length > 0 && (
												<div className="mb-2 col-lg-6 col-md-6 col-sm-6 col-12">
...
export default AddcustomizedtourNew;

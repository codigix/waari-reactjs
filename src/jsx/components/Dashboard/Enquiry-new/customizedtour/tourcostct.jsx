...
import OfferPopup from "../../Customizedbooking/OfferPopup";
...
const TourCostCT = ({
	...
	const validation = useFormik({
		...
		onSubmit: async (values) => {
			...
			try {
				...
				const response = await post(`/tour-cost-ct`, data);
	...
	const getTourCostDetails = async () => {
		try {
			const response = await get(
				`/get-tour-cost-ct?enquiryDetailCustomId=${familyHead.enquiryDetailCustomId}&enquiryCustomId=${enquiryId}&guestId=${familyHead.guestId}`
			);
	...
	const getAppliedCouponDetails = async () => {
		try {
			const response = await get(
				`/get-coupon-uses-ct?guestId=${familyHead.guestId}&enquiryCustomId=${enquiryId}`
			);

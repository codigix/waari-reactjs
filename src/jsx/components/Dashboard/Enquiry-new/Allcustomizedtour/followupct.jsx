...
const FollowupCT = ({ enquiryId }) => {
	...
	const validationLost = useFormik({
		...
		validationSchema: Yup.object({
			closureReason: Yup.string().required("Enter The Closure Reason"),
		}),
									...
									<div className="row mt-4">
										...
										<div className="col-md-6 col-lg-4 col-sm-6 col-12  mx-auto mb-2 justify-content-center d-flex">
											<button
												...
												onClick={() =>
													navigate(`/enquiry-ct/${enquiryId}?activeTab=journey`)
												}
											>
				...
				<Box sx={style}>
					<Typography>
						<button
							...
							className="close d-flex justify-content-end text-danger text-right "
						>
							<span>&times;</span>
						</button>
					</Typography>

                            ...
                            <>
                                ...
                                <div className="row mb-2 form-group">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <ErrorComponentArray
                                            fieldName="roomShareTypeLabel"
                                            key="roomShareTypeLabel"
                                            index={index}
                                            touched={validation.touched.guestDetails}
                                            errors={validation.errors.guestDetails}
                                        />
                                ...
                                <div className="row mb-2 form-group">
                                    <div className="col-md-2">
                                        <label className="text-label">Upload PAN{index == 0 ? <span className="error-star">*</span> : "" }</label>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="Neon Neon-theme-dragdropbox">
                                            <input
                                ...
                                <div className="row mb-2 form-group">
                                    <div className="col-md-2">
                                        <label className="text-label">PAN Number{index == 0 ? <span className="error-star">*</span> : "" }</label>
                                    </div>
                                    <div className="col-md-6">
                                        <input
                                            type="text"

...
const Enquiryct = () => {
	...
	const {
		callCount,
		groupName,
		groupTourCompletionStatusCount,
		isFamilyHeadDataFilled,
		isPaymentDone,
	...
	const tabs = [
		...
		},
		{
			...
			label: "Booking Forms",
			requiredId: 245,
			tabClickAllowed: isFamilyHeadDataFilled,
		},
		{
			path: "payment",
			label: "Payment Details",
			requiredId: 246,
			tabClickAllowed: isFamilyHeadDataFilled && isPaymentDone,
		},
		{
			path: "document",
			label: "Documents",
	...
	useEffect(() => {
		...
		let element = document.getElementById("all-customized-tour-new");
		if (element) {

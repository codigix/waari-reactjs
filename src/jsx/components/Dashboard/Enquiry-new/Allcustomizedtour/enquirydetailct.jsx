    ...
    const validation = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                navigate(`/all-enquiry-ct/${id}?activeTab=followup`);
                            ...
                            <div className="row">
                                <div className="mb-2 col-lg-4 col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <input
                                        ...
                                        style={{
                                            backgroundColor: isEnqNonEditable ? "#f3f3f3" : "",
                                        }}
                                    />
                                ...
                                <div className="mb-2 col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                    ...
                                    <Select
                                        ...
                                        isDisabled={
                                            validation.values.destination == "1" || isEnqNonEditable
                                        }
                                    />
                                ...
                                <div className="mb-2 col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                    ...
                                    {validation.touched.duration && validation.errors.duration ? (
                                        <span className="error">{validation.errors.duration}</span>
                                    ) : null}
                                </div>
                                ...
                                <div className="mb-2 col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                    ...
                                    <Select
                                        ...
                                        isDisabled={isEnqNonEditable}
                                    />
                                    {validation.touched.mealplan && validation.errors.mealplan ? (
                                        <span className="error">{validation.errors.mealplan}</span>
                                    ) : null}
                                </div>
                                <div className="mb-2 col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                    <label>
                            ...
                            <div className="mb-2 mt-2 row">
                                <div className="col-lg-12 d-flex justify-content-between">
                                    ...
                                    <button
                                        ...
                                        disabled={isLoading || isEnqNonEditable}
                                    >

...
import { updateFamilyHeadDataCompletionStatus, updateGroupNameGT } from "../../../../../store/actions/groupTourAction";
...
const Journeys = ({ enquiryId }) => {
	...
	const fetchNameOptions = async () => {
		try {
			...
			if (response.data.data.length > 0) {
				...
				familyHeadsFormik.setFieldValue(`familyHeads[${familyHeadIndex}].firstName`, searchTerm);
			} else {
				setNameOptions([]);
				familyHeadsFormik.setFieldValue(`familyHeads[${familyHeadIndex}].firstName`, searchTerm);
	...
	const handleNameChange = (selectedOption) => {
		...
		if (selectedOption) {
			...
			familyHeadsFormik.setFieldValue(`familyHeads[${familyHeadIndex}].firstName`, selectedOption.label);
			familyHeadsFormik.setFieldValue(`familyHeads[${familyHeadIndex}].guestId`, selectedOption.value);
	...
	const getGuestInfoByName = async (name) => {
		try {
			...
			if (result.data) {
				familyHeadsFormik.setFieldValue(`familyHeads[${familyHeadIndex}].namePreFix`, preFixId ? preFixId : 1);
				familyHeadsFormik.setFieldValue(`familyHeads[${familyHeadIndex}].lastName`, lastName);
			}
		} catch (error) {
			console.log(error);
		}

...
const Payment = ({ enquiryId, familyHead }) => {
    ...
    const validation = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                // navigate("/confirm-group-tour-new");
            ...
            >
                <div className="row mb-2 form-group">
                    ...
                    <div className="col-md-6">
                        ...
                        />
                        {validation.touched.totaltourprice && validation.errors.totaltourprice ? (
                ...
                <div className="row mb-2 form-group">
                    ...
                    <div className="col-md-6">
                        <textarea
                            ...
                            value={
                                sameAddress ? sameAsCheckData.address : validation.values.address
                            }
                ...
                <div className="row mb-2 form-group">
                    ...
                    <div className="col-md-6">
                        <input
                            ...
                            value={
                                sameContact ? sameAsCheckData.phoneno : validation.values.phoneno
                            }
                        />
                ...
                <div className="row mb-2 form-group">
                    ...
                    <div className="col-md-6">
                        ...
                        />
                        {validation.touched.dateofpayment && validation.errors.dateofpayment ? (

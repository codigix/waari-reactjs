...
const Enquiry = () => {
	...
	const tabs = [
		{ path: "enquiryDetails", label: "Enquiry Details", requireId: 28, tabClickAllowed: true },
		{ path: "followup", label: "Follow-up/Call log", requireId: 27, tabClickAllowed: true },
		{ path: "journey", label: "Journeys", requireId: 30, tabClickAllowed: true },
		{ path: "booking", label: "Booking Forms", requireId: 144, tabClickAllowed: isFamilyHeadDataFilled },
		{ path: "payment", label: "Payment Details", requireId: 145, tabClickAllowed: isFamilyHeadDataFilled && isPaymentDone },
		{ path: "document", label: "Documents", requireId: 148, tabClickAllowed: isFamilyHeadDataFilled },

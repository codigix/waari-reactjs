...
const Guestdetails = ({
	...
	const [alreadySubmittedGuestsData, setAlreadySubmittedGuestsData] =
		useState(true);
	...
	console.log(validation.values.guestDetails);
	return (
		<section>
			<form
									...
									{index == 0 ? (
										<div className="col-md-6">
											...
											{validation.touched.guestDetails &&
												validation.touched?.guestDetails?.[index]?.preFixId &&
												validation.errors &&
												validation.errors?.guestDetails &&
												validation.errors.guestDetails?.[index]?.preFixId && (
								...
								<div className="row mb-2 form-group">
									...
									{index == 0 ? (
										...
										<div className="col-md-6">
											...
											/>
											{validation.touched.guestDetails &&
												validation.touched?.guestDetails?.[index]?.firstName &&
												validation.errors &&
												validation.errors?.guestDetails &&
												validation.errors.guestDetails?.[index]?.firstName && (
													<span className="error">
														{validation.errors.guestDetails?.[index]?.firstName}
													</span>
												)}
								...
								<div className="row mb-2 form-group">
									...
									{index == 0 ? (
										<div className="col-md-6">
											...
											/>
												{validation.touched.guestDetails &&
												validation.touched?.guestDetails?.[index]?.lastName &&
												validation.errors &&
												validation.errors?.guestDetails &&
												validation.errors.guestDetails?.[index]?.lastName && (
													<span className="error">
														{validation.errors.guestDetails?.[index]?.lastName}
													</span>
												)}

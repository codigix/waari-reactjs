                                                                    ...
                                                                    <div className="mb-2 d-flex justify-content-end">
                                                                        {item.isFinal == 1 && (
                                                                            <div>
                                                                             ...
                                                                             {
																			hasComponentPermission(permissions, 301) &&	  <button type="button">
                    ...
                    <div className="basic-form">
                        ...
                        >
                            ...
                            <div className="row">
                                ...
                                <div className="card-header card-header-title mb-2 p-0">
                                ...
                                {validation?.values?.enquiryref == 9 && (
                                    <div className="mb-2 col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                        <label>
                                            Guest Reference Id<span className="error-star">*</span>
                                        </label>
                                        <Select
                                            disabled
                                            styles={customStyles}

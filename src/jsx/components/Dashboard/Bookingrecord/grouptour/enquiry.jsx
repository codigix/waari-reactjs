...
const Enquiry = () => {
	...
	const tabs = [
		{ path: "enquiryDetails", label: "Enquiry Details", requiredId: 95 },
		{ path: "followup", label: "Follow-up/Call log", requiredId: 96 },
		{ path: "journey", label: "Journeys", requiredId: 177 },
		{ path: "booking", label: "Booking Forms", requiredId: 178 },
		{ path: "payment", label: "Payment Details", requiredId: 179 },
		{ path: "document", label: "Documents", requiredId: 180 },
		{ path: "canceltour", label: "Cancel Tour", requiredId: 182 },
	];

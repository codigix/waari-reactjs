...
const BookingGrouptourRecord = () => {
    ...
    const columns = [
        ...
        hasComponentPermission(permissions, 95) && {
            title: "Billing",
            render: (item) => (
                <>
                    <div className="d-flex justify-content-center">
                        <Link
                            to={`/booking-enquiry/${item?.enquiryId}/${item.familyHeadGtId}`}
                            className="btn-tick"
                        >
                            <Tooltip title="View">
                                <svg
    ...
    const getViewgrouplist = async () => {
        try {
            ...
            const response = await get(
                `/booking-records?perPage=${perPageItem}&page=${page}&guestName=${guestname}&tourTypeId=${
                    tourType?.value || ""
                }&destinationId=${
                    destination?.value || ""
                            ...
                            <div className="card">
                                <div className="row page-titles mx-0 fixed-top-breadcrumb">
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item  ">
                                            <Link to="/booking-group-tour-new">Group Tour</Link>
                                        </li>
                                    </ol>
                                </div>
                            </div>

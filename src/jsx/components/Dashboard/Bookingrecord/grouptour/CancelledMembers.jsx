		...
		<form>
			...
			<div className="row">
				<div className="col-md-6">
					...
					{cancelledMember.refundAmount > 0 ? <div className="mb-2">
						...
						<div className="mb-2">
							...
							<Select
								isDisabled={
									...
									!hasComponentPermission(permissions, 183)
								}
								styles={customStyles}
			...
			<div className="mb-2 mt-4 row d-flex justify-content-center">
				<div className="col-lg-8">
					<div className="row">
						{Number(cancelledMember.cancelType) === 1 ? (
							<>
								{hasComponentPermission(permissions, 184) && (
								...
								{cancelledMember.refundProof &&
									hasComponentPermission(permissions, 185) && (
										<div className="col-md-6 col-lg-4 col-sm-6 col-12  mx-auto mb-2 justify-content-center d-flex">
											<a

...
const Journeys = ({ enquiryId }) => {
    ...
    const getEnquiryDetails = async () => {
        try {
            ...
            const dataa = Array.from({ length: Number(response.data.familyHeadNo) }, () => ({
                ...familyDetailsObj,
            }));
    ...
    const getFamilyHeads = async () => {
        try {
            const response = await get(`/familyHead-list-gt?enquiryGroupId=${enquiryId}`);
                            ...
                            <div className="basic-form">
                                ...
                                >
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card-header mb-2 pt-0 card-header-title">
                                            ...
                                            <div className="mb-2 col-lg-3 col-md-6 col-sm-6 col-xs-6">
                                                ...
                                                <Select
                                                    ...
                                                    value={guestenquiryref.find(
                                                        (option) =>
                                                            option.value ===
                                                            validation.values.guestenquiryref
                                                    )}
                                                    isDisabled
                                                />
                                                <ErrorMessageComponent

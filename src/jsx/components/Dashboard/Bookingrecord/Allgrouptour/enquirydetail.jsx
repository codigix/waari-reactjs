...
const AddEnquiryGT = ({ enquiryId }) => {
  const getEnquiryDetails = async () => {
    try {
      const enquiryGroupId = selectedEnquiry?.enquiryGroupId; // make sure this is defined

      const response = await get(
        `${import.meta.env.VITE_WAARI_BASEURL}/enqGroup-details?enquiryGroupId=${enquiryGroupId}`
      );

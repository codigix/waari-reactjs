...
const Enquiryct = () => {
	...
	const tabs = [
		{ path: "enquiryDetails", label: "Enquiry Details", requiredId: 98 },
		{ path: "followup", label: "Follow-up/Call log", requiredId: 99 },
		{ path: "journey", label: "Journeys", requiredId: 186 },
		{ path: "booking", label: "Booking Forms", requiredId: 187 },
		{ path: "payment", label: "Payment Details", requiredId: 188 },
		{ path: "document", label: "Documents", requiredId: 189 },
		{ path: "canceltour", label: "Cancel Tour", requiredId: 191 },
		{ path: "vouchers", label: "Vouchers", requiredId: 287 },
	];
	...
	useEffect(() => {
		...
		// console.log(path);
		let element = document.getElementById("booking-custom-tour-new");
		// console.log(element);
		if (element) {

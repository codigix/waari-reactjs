...
const BookingRecordCustomizeTours = () => {
    ...
    const columns = [
        ...
        //   width: 80,
        // },
        hasComponentPermission(permissions, 98) && {
            title: "Billing",
            render: (item) => (
                <>
                    <div className="d-flex justify-content-center">
                        <Link to={`/booking-custom-enquiry/${item.enquiryId}`} className="btn-tick">
                            <Tooltip title="View">
                                <svg
    ...
    const getViewgrouplist = async () => {
        try {
            ...
            const response = await get(
                `/booking-record-ct?perPage=${perPageItem}&page=${page}&guestName=${guestName}&groupName=${groupName}&bookingDateFrom=${bookingDateFrom}&bookingDateTo=${bookingDateTo}&travelDateFrom=${travelDateFrom}&travelDateTo=${travelDateTo}&destinationId=${
                    destination?.value || ""
                }`
            );
            setIsLoading(false);
                            ...
                            <div className="card">
                                <div className="row page-titles mx-0 fixed-top-breadcrumb">
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item  ">
                                            <Link to="/booking-custom-tour-new">
                                                Customized Tour
                                            </Link>
                                        </li>
                                    </ol>

...
const Enquiryct = () => {
	...
	const tabs = [
		{ path: "enquiryDetails", label: "Enquiry Details", requiredId: 250 },
		{ path: "followup", label: "Follow-up/Call log", requiredId: 251 },
		{ path: "journey", label: "Journeys", requiredId: 252 },
		{ path: "booking", label: "Booking Forms", requiredId: 253 },
		{ path: "payment", label: "Payment Details", requiredId: 254 },
		{ path: "document", label: "Documents", requiredId: 256 },
		{ path: "canceltour", label: "Cancel Tour", requiredId: 258 },
		{ path: "vouchers", label: "Vouchers", requiredId: 285 },
	];
	...
	useEffect(() => {
		...
		// console.log(path);
		let element = document.getElementById("all-confirm-custom-tour-new");
		// console.log(element);
		if (element) {

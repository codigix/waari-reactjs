...
const Enquiry = () => {
	...
	const tabs = [
		{ path: "enquiryDetails", label: "Enquiry Details", requiredId: 39 },
		{ path: "followup", label: "Follow-up/Call log", requiredId: 40 },
		{ path: "journey", label: "Journeys", requiredId: 157 },
		{ path: "booking", label: "Booking Forms", requiredId: 158 },
		{ path: "payment", label: "Payment Details", requiredId: 159 },
		{ path: "document", label: "Documents", requiredId: 161 },
		{ path: "canceltour", label: "Cancel Tour", requiredId: 163 },
	];
	...
	useEffect(() => {
		...
		// console.log(path);
		let element = document.getElementById("confirm-group-tour-new");
		// console.log(element);
		if (element) {

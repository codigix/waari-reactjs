...
const Enquiryct = () => {
	...
	const tabs = [
		{ path: "enquiryDetails", label: "Enquiry Details", requiredId: 42 },
		{ path: "followup", label: "Follow-up/Call log", requiredId: 43 },
		{ path: "journey", label: "Journeys", requiredId: 167 },
		{ path: "booking", label: "Booking Forms", requiredId: 168 },
		{ path: "payment", label: "Payment Details", requiredId: 169 },
		{ path: "document", label: "Documents", requiredId: 171 },
		{ path: "canceltour", label: "Cancel Tour", requiredId: 173 },
		{ path: "vouchers", label: "Vouchers", requiredId: 283 },
	];
	...
	useEffect(() => {
		...
		// console.log(path);
		let element = document.getElementById("confirm-custom-tour-new");
		// console.log(element);
		if (element) {

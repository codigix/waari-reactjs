...
const CancelledMembers = ({
	...
	const data = {
		...
		enquiryDetailCustomId: enquiryDetailCustomId,
		customGuestDetailsId: cancelledMember.customGuestDetailsId,
	};
	...
	const handleStatusChange = async (event) => {
		if (Number(event.value) === 1) {
			try {
				...
				const result = await post("cancel-status-update-ct", finalData);
						...
						<div className="mb-2">
							...
							<Select
								isDisabled={
									...
									!hasComponentPermission(permissions, 174)
								}
								styles={customStyles}
			...
			<div className="mb-2 mt-4 row d-flex justify-content-center">
				<div className="col-lg-8">
					<div className="row">
						{Number(cancelledMember.cancelType) === 1 ? (
							<>
								{hasComponentPermission(permissions, 175) && (
								...
								{cancelledMember.refundProof &&
									hasComponentPermission(permissions, 176) && (
										<div className="col-md-6 col-lg-4 col-sm-6 col-12  mx-auto mb-2 justify-content-center d-flex">
											<a

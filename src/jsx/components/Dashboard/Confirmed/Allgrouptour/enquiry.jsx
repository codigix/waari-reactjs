...
const Enquiry = () => {
	...
	const tabs = [
		{ path: "enquiryDetails", label: "Enquiry Details", requiredId: 212 },
		{ path: "followup", label: "Follow-up/Call log", requiredId: 213 },
		{ path: "journey", label: "Journeys", requiredId: 214 },
		{ path: "booking", label: "Booking Forms", requiredId: 215 },
		{ path: "payment", label: "Payment Details", requiredId: 216 },
		{ path: "document", label: "Documents", requiredId: 218 },
		{ path: "canceltour", label: "Cancel Tour", requiredId: 221 },
	];
	...
	useEffect(() => {
		...
		// console.log(path);
		let element = document.getElementById("all-confirm-group-tour-new");
		// console.log(element);
		if (element) {

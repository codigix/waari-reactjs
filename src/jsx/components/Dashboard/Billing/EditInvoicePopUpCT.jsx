...
function EditInvoicePopUp({ invoiceData, onClose, enquiryDetailCustomId }) {
	...
	return (
		<div>
			<h6 className="modal-h6" style={{ textAlign: "center" }}>Edit Invoice - {invoiceData?.invoiceNo}</h6>
			<div>

...
import EditReceiptPopUp from "./EditReceiptPopUpGT";
...
const Receipt = () => {
	...
	const getReceiptData = async () => {
		try {
			...
			const response = await get(
				`/view-receipt?groupPaymentDetailId=${idPayment}&familyHeadGtId=${id}`
			);
	...
	return (
		<>
			...
			<div className="card card-btn">
				...
				<div className="card-body">
					<div className="no-print d-flex justify-content-end gap-2">
						{hasComponentPermission(permissions, 146) && (
							<button
			...
			<div className="card">
				<div className="card-body">
					...
					<div className="row mt-2 mb-2 invoice-details">
						<div className="col-md-3">
							<div className="bill-details">
								<p className="mb-0 col-md-2 bill-to">Bill To </p>
								<h3>
									{isLoading
										? "Loading..."
                  ...
                  <div className="card-title h5">Advance Receipts </div>
					...
					<div className="invoice-table-details mt-3  mb-2">
              ...
              <div className="form-group  d-flex justify-content-between">
                ...
                <p className="mb-0">₹ {isLoading ? "Loading..." : !!(receiptData?.remainingAmount)?receiptData?.remainingAmount:"-"}</p>
					...
					<div className="row invoice-word mt-3">
						<div className="col-md-9">
							<div className="form-group d-block">
								...
								<h3 className="mb-0">
									{/* {`${isLoading ? "Loading..." : !!(receiptData?.advancePayment)?toWords.convert(receiptData?.advancePayment):"-"}`} */}
									{`${
										isLoading
											? "Loading..."
											: !!receiptData?.advancePayment
					...
					<div className="invoice-data mt-3 mb-3">
			...
			>
				<p>©2021-22 Musmade Hospitality Pvt Ltd. All
				Rights Reserved.</p>
			</footer>
		</>
	);

...
function EditReceiptPopUp({ receiptData, onClose, familyHeadGtId }) {
	...
	const validation = useFormik({
		...
		initialValues: {
			billingName: receiptData?.billingName || "",
			phoneNo: receiptData?.phoneNo || "",
			address: receiptData?.address || "",
			gstin: receiptData?.gstin || "",
			panNo: receiptData?.panNo || "",
		},
	...
	return (
		<div>
			<h6 className="modal-h6" style={{ textAlign: "center" }}>
				Edit Receipt - {receiptData?.receiptNo}
			</h6>
			<div>
				<div className="basic-form">
					...
					>
						...
						<div className="row">
							...
							<div className="mb-2 col-md-6 col-lg-6 col-sm-6 col-123">
								<label className="form-label">
									Contact No.
								</label>
							...
							<div className="col-md-12 col-lg-12 col-sm-12s col-12 mb-2">
								<label>
									Address
...
export default EditReceiptPopUp;

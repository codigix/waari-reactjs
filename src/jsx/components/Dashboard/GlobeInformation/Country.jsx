                          ...
                          {hasComponentPermission(permissions, 62) && (
                              <div className="d-flex justify-content-center">
                                  <Link
                                      className="btn-trash"
                                      onClick={() =>
                                          handleOpenDelete(item?.countryId)
                                      }
                                  >
    ...
    const handleDelete = async () => {
        try {
            ...
            const responseData = await get(
                `/delete-country?countryId=${deleteId}`
            );
            setOpen(false);
            setIsLoading(false);
            getCountryList();
                            ...
                            <div>
                                <div className="lg:mb-3 mb-3 md:mb-3 form-group">
                                    ...
                                    <input
                                        ...
                                        value={
                                            validationUpdate.values.countryName
                                        }
                                    />
                                ...
                                <div className=" col-12">
                                    <div className="mb-3">
                                        ...
                                        <textarea
                                            ...
                                            value={
                                                validationUpdate.values.description
                                            }
                                            style={{ overflow: "hidden" }}
                                        />

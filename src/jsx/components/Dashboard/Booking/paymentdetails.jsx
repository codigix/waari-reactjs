...
const StepFour = ({ roomSharedId, grandTotal, totalData, moveToStep4 }) => {
  // to- words
  ...
  const showSameBillingName = async (event) => {
    if (event.target.checked) {
      validation.setFieldValue("billingname", grandTotal?.guestDetails[0]?.familyHeadName);
    } else {
  ...
  const showSameAddress = async (event) => {
    if (event.target.checked) {
      validation.setFieldValue("address", grandTotal?.guestDetails[0]?.address);
    } else {
  ...
  const showSameContact = async (event) => {
    if (event.target.checked) {
      validation.setFieldValue("phoneno", grandTotal?.guestDetails[0]?.contact);
    } else {
  ...
  const uploadFile = async (e) => {
    try {
      ...
      validation.setFieldValue('proof', e.target.files[0].name)
  ...
  const validation = useFormik({
    ...
    initialValues: {
      totaltourprice: grandTotal ? grandTotal?.grandtotal : "",
      advanced: "",
      billingname: "",
      address: "",
      phoneno: "",
    ...
    onSubmit: async (values) => {
      let data = {
        enquiryGroupId: roomSharedId,
        travelId: totalData?.vehicletype.value,
        departureTypeId: totalData?.guesttype.value,
        arrivalTime: totalData?.timeofarrival,
        paxNo: totalData?.pax,
        guestRefId: totalData?.referenceguestid,
        groupGuestDetails: totalData?.guestDetails,
        tourPrice: totalData?.tourprice,
        additionalDis: totalData?.points,
        discountPrice: totalData?.discountprice,
        gst: totalData?.gst,
        tcs: totalData?.tcs,
        points: totalData?.points,
        grandTotal: totalData?.grandtotal,
        ...
        balance: Number(grandTotal?.grandtotal) - Number(values?.advanced),
        ...
        couponId: totalData?.couponId
      };
      try {
        setIsLoading(true);
        const response = await post(`/enquiry-group-details`, data);
  ...
  // to-words in amount 
  const amountInWords = validation.values.advanced ? toWords.convert(validation.values.advanced, { currency: true }) : "-";
  ...
  return (
    <section>
      ...
      >
        ...
        <div className="row mb-2 form-group">
          <div className="col-md-2">
            <label className="text-label">Billing Name<span className="error-star">*</span></label>
          </div>
          <div className="col-md-6">
            <input
              type="text"
              ...
              value={
                sameBillingName
                  ? grandTotal?.guestDetails[0]?.familyHeadName
        ...
        <div className="row mb-2 form-group">
          ...
          <div className="col-md-6">
            <textarea
              ...
              value={
                sameAddress
                  ? grandTotal?.guestDetails[0]?.address
        ...
        <div className="row mb-2 form-group">
          ...
          <div className="col-md-6">
            <input
              ...
              value={
                sameContact
                  ? grandTotal?.guestDetails[0]?.contact
        ...
        {(validation.values.paymentmode == 2) && (
          <div className="row mb-2 form-group">
            <div className="col-md-2">
              <label className="text-label">Bank Name<span className="error-star">*</span></label>
            </div>
            <div className="col-md-6">
              <input
                type="text"
        ...
        {validation.values.paymentmode == 2 && (
          <div className="row mb-2 form-group">
            <div className="col-md-2">
              <label className="text-label">Cheque Number<span className="error-star">*</span></label>
            </div>
            <div className="col-md-6">
              <input
                type="text"
        ...
        {validation.values.paymentmode == 1 && (
          <div className="row mb-2 form-group">
            <div className="col-md-2">
              <label className="text-label">Transaction ID<span className="error-star">*</span></label>
            </div>
            <div className="col-md-6">
              <input
                type="text"
        ...
        <div className="row mb-2 form-group">
          <div className="col-md-2">
            <label className="text-label">Transaction Proof<span className="error-star">*</span></label>
          </div>
          <div className="col-md-6">
            <input
              type="file"
        ...
        <div className="row mb-2 form-group">
          ...
          <div className="col-md-6">
            <input
              ...
              onBlur={null}
              value={
                Number(grandTotal?.grandtotal) -
                Number(validation.values.advanced)
              }
            />

...
const ViewTailorMadeTourDetails = () => {
    const { id } = useParams();
    ...
    const getViewgrouplist = async () => {
        try {
            setIsLoading(true);
            const response = await get(`/view-details-tailor-made?tailorMadeId=${id}`);

            setData(response.data);
            setGrouptour(response?.data?.detailTailorMade);
            ...
            setInclusions(response?.data?.tailormadeinclusions);
            setExclusions(response?.data?.tailormadeexclusions);
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="notes">
                                        ...
                                        <ul className="list-type view-details">
                                            <li>
                                                {" "}
                                                {!!grouptour[0]?.websiteDescription
                                                    ? grouptour[0].websiteDescription
                                                    : "-"}
                                            </li>
                                        </ul>
...
export default ViewTailorMadeTourDetails;

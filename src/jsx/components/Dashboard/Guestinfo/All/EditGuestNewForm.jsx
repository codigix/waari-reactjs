...
function EditGuestNewForm() {
	...
	const getGuestDetails = async () => {
		try {
			const result = await get(`users-details?userId=${id}`);
			const {
				preFixId,
				firstName,
				lastName,
			...
			formik.setFieldValue("preFixId", preFixId || "");
			formik.setFieldValue("firstName", firstName || "");
			formik.setFieldValue("lastName", lastName || "");
			formik.setFieldValue("phone", phone || "");
			formik.setFieldValue("adhar", adhar || "");
			formik.setFieldValue("adharNo", adharNo || "");
			formik.setFieldValue("pan", pan || "");
			formik.setFieldValue("panNo", panNo || "");
			const cardIdOption = loyaltyCardOption.find(
				(item) => item.value == cardId
			);
			formik.setFieldValue("cardId", cardIdOption);
			formik.setFieldValue("passport", passport || "");
			formik.setFieldValue("passportNo", passportNo || "");
			formik.setFieldValue("loyaltyPoint", loyaltyPoint || "");
			formik.setFieldValue("dob", dob || "");
			formik.setFieldValue("dom", dom || "");
	...
	const formik = useFormik({
		...
		onSubmit: async (values) => {
			try {
				...
				const result = await post("update-user-data", data);
				...
				<div className="col-lg-12" style={{ paddingTop: '40px' }}>
					...
					<div className="card">
						<div className="card-header">
							<div className="card-title h5">Update Guest</div>
						</div>
						<div className="card-body">
							<form onSubmit={formik.handleSubmit} className="needs-validation">
										...
										<div className="mb-2">
											...
											<Select
												...
												value={namePreFix.find(
													(option) => option.value === formik.values.preFixId
												)}
											/>
								...
								<div className="col-lg-12 d-flex justify-content-between mt-3">
									<Link to="/all-guest-list" type="submit" className="btn btn-back">
										Back
									</Link>
...
export default EditGuestNewForm;

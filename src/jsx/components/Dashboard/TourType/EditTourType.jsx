...
const EditTourType = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                const result = await post(`edit-tour-type?tourTypeId=${id}`, data);
    ...
    const getData = async () => {
        try {
            const result = await get(`get-edit-tour-type?tourTypeId=${id}`);
            const { tourTypeName, tourTypeImage } = result?.data?.data;

            formik.setFieldValue("tourTypeName", tourTypeName || "");
            formik.setFieldValue("tourTypeImage", tourTypeImage || "");
        } catch (error) {
            console.log(error);
        }
    };
                    ...
                    <div className="card">
                        <div className="row page-titles mx-0 fixed-top-breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item  ">
                                    <Link to="javascript:void(0)">Edit Tour Type</Link>
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="card-header mb-2 p-0">
                                <div className="card-title h5">Edit Tour Type</div>
                            </div>
